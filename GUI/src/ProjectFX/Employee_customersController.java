 ...
 * @author vpddk
 */
public class Employee_customersController implements Initializable {
    ...
    int curr_cust_fpk,curr_cust_spk,curr_cut_ffpk,city_new;
    ...
    private void show_stoixeia(MouseEvent event) {
       ...
       rent_button.setDisable(false);
        ...
        else if(curr_cust_spk==1){
            curr_cust_pack.setText("Series pack");
           
        }
        else if(curr_cust_fpk==1){
